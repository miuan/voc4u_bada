...
{
			if( lesson == 1 && lang == "CS"){ count = DATA_CS_1::num;return (wchar_t**)DATA_CS_1::texts;}
		...
		if( lesson == 2 && lang == "CS"){ count = DATA_CS_2::num;return (wchar_t**)DATA_CS_2::texts;}
		...
		if( lesson == 3 && lang == "CS"){ count = DATA_CS_3::num;return (wchar_t**)DATA_CS_3::texts;}
		...
		if( lesson == 4 && lang == "CS"){ count = DATA_CS_4::num;return (wchar_t**)DATA_CS_4::texts;}
		...
		if( lesson == 5 && lang == "CS"){ count = DATA_CS_5::num;return (wchar_t**)DATA_CS_5::texts;}
