...
wchar_t ** getInitData(String lang, const int lesson, int &count)
{
		...
		if( lesson == 1 && lang == "EN"){ count = DATA_EN_1::num;return (wchar_t**)DATA_EN_1::texts;}
		...
		if( lesson == 1 && lang == "IT"){ count = DATA_IT_1::num;return (wchar_t**)DATA_IT_1::texts;}
		...
		if( lesson == 2 && lang == "EN"){ count = DATA_EN_2::num;return (wchar_t**)DATA_EN_2::texts;}
		...
		if( lesson == 2 && lang == "IT"){ count = DATA_IT_2::num;return (wchar_t**)DATA_IT_2::texts;}
		...
		if( lesson == 3 && lang == "EN"){ count = DATA_EN_3::num;return (wchar_t**)DATA_EN_3::texts;}
		...
		if( lesson == 3 && lang == "IT"){ count = DATA_IT_3::num;return (wchar_t**)DATA_IT_3::texts;}
		...
		if( lesson == 4 && lang == "EN"){ count = DATA_EN_4::num;return (wchar_t**)DATA_EN_4::texts;}
		...
		if( lesson == 4 && lang == "IT"){ count = DATA_IT_4::num;return (wchar_t**)DATA_IT_4::texts;}
		...
		if( lesson == 5 && lang == "EN"){ count = DATA_EN_5::num;return (wchar_t**)DATA_EN_5::texts;}
		...
		if( lesson == 5 && lang == "IT"){ count = DATA_IT_5::num;return (wchar_t**)DATA_IT_5::texts;}
